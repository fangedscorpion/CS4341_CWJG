    ...
    def fixChild(self, listOfChangedNums):
        ...
        for x in range(0, len(listOfChangedNums) - 1):
            ...
            if(listOfChangedNums[ind1][0] == 1):
                self.bin1[listOfChangedNums[ind2][1]] = listOfChangedNums[
                    ind2][2]
            elif(listOfChangedNums[ind1][0] == 2):
                self.bin2[listOfChangedNums[ind2][1]] = listOfChangedNums[
                    ind2][2]
            elif(listOfChangedNums[ind1][0] == 3):
                self.bin3[listOfChangedNums[ind2][1]] = listOfChangedNums[
                    ind2][2]

            if(listOfChangedNums[ind2][0] == 1):
                self.bin1[listOfChangedNums[ind1][1]] = listOfChangedNums[
                    ind1][2]
            elif(listOfChangedNums[ind2][0] == 2):
                self.bin2[listOfChangedNums[ind1][1]] = listOfChangedNums[
                    ind1][2]
            elif(listOfChangedNums[ind2][0] == 3):
                self.bin3[listOfChangedNums[ind1][1]] = listOfChangedNums[
                    ind1][2]
